...
var cmakeBadgeEntityID = 'dHgXDlBtTCa1Re-LwGo5pw';
...
issueAssertionToTestUser(computingBootCampId, cmakeBadgeEntityID, userEmail, accessToken);
...
Forked Repository";
    else console.log("Success! CMake Badge has been issued to" + userEmail);
    //return JSON.parse(xhr.responseText);
}